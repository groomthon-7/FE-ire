...
import inactiveSpring from './assets/Research/spring_gray.png';
import inactiveSummer from './assets/Research/summer_gray.png';
import inactiveFall from './assets/Research/fall_gray.png';
import inactiveWinter from './assets/Research/winter_gray.png';
...
export const researchData = [
  ...
  },
  {
    ...
    contents: [
      { title: '봄', img: [spring, inactiveSpring] },
      { title: '여름', img: [summer, inactiveSummer] },
      { title: '가을', img: [fall, inactiveFall] },
      { title: '겨울', img: [winter, inactiveFall] },
    ],
  },
];
